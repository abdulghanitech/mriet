...
<div class="row custom-row-grey-color">
	...
	<div class="row">
		...
		<div class="col-md-8">
				...
				<img src="img/ece.jpg" class="img-responsive center-block" style="width: 70%;">
						
		
		<h3 class="page-header">Vision and Mission</h3>                   
                            <p><strong>Vision of the Department:</strong></p>
    <p>1. To produce globally competitive and socially sensitized Engineering graduates and to establish the dept as a center of excellence by bringing out the professional competence in the core areas of Electronics and Communication Engineering.

</p><br />
    <p><strong>Mission of the Department:</strong></p>
    <p>1. To Provide Quality Education in the domain of Electronics and Communication Engineering</p>
