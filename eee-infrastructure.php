...
<div class="row custom-row-grey-color">
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="row">
				<div class="col-md-6">
				<p style="font-size: 18px;" align="justify" class="para-margin-fix">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	Department of EEE has a total of 8 well established Laboratories. The labs are equipped with all the advanced softwares and latest computer systems. Student-to-computer ratio of 1:1 is maintained to faclitate easy access and availability of more time to students to practise in the labaratories. All the labs are connected with internet.
										</p>
			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
				<p style="font-size: 18px;" align="justify" class="para-margin-fix">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	The Department of EEE has software to cater all needs of students. The software present are Windows 8, MS Office, Oracle 11g, Borland Turbo C++, SCO Unix 5.0.6 Enterprise, Rational Rose Enterprise Edition, Data Warehousing & Mining tools.
										</p>
